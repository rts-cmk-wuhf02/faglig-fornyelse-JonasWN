    ...
    return (
      <form action="" className={"task-form " + (props.display ? "display" : "")}>
        ...
        <div className="task-item__info">
          <input className="info__heading task-form__input" placeholder="Task Name" onChange={onChange} value={title}/>
          <input className="info__time task-form__input time" placeholder="Time" onChange={handleTime} value={date}/>
        </div>
